...
create or replace FUNCTION ob_Account_Aggregation_Service
(
...
AS
    ...
    m_xpath_node                    OB_XPATH_INSTPARMPATH_MAP.xpath_node%TYPE   := 'Customer/AccountAggregationService/';
    ...
    m_PaymentType                   VARCHAR2(500)                               := NULL;
    ...
    BEGIN
        ...
        BEGIN
            ...
            INTO    m_ServiceSubscription,
                    ...
                    m_IsSms,
                    m_domain
            FROM    XMLTable('/ProductConfiguration/Customer/AccountAggregationService' PASSING m_onboard_xtype
...
--                    SupportMobileNo         VARCHAR2(255)  PATH 'SupportMobileNo'
        ...
        THEN
            DBMS_OUTPUT.put_line('AccountAggregationService not subscribed !');
		...
		DBMS_OUTPUT.put_line('-----------------------AccountAggregationService---------------------------');
        ...
        DBMS_OUTPUT.put_line(RPAD('IsSms:',35,' ')|| m_paramvalue);
            ...
            DBMS_OUTPUT.put_line('-----------------------End of AccountAggregationService---------------------');
    ...
    EXCEPTION
        ...
        THEN
            ...
            AND PATH LIKE 'ACCOUNT_AGGREGATION_SERVICE%';
            COMMIT;

            DBMS_OUTPUT.PUT_LINE('Rows deleted : '||SQL%ROWCOUNT);

            m_return_code := mgmt_institutionparameter(p_action=>'INSERT-UPDATE',p_institutionid=>m_institutionid, p_path_old=>'ACCOUNT_AGGREGATION_SERVICE.ACCOUNT.SUBSCRIPTION', p_paramname=>'SUBSCRIPTION', p_paramvalue=>'NO');

            m_audittext := 'AccountAggregationService not subscribed.';
            RAISE OB_AUDIT_LOG;
            RETURN 0;
